...
import { createFAQCategory } from "@/services/faqcategory.service";
import { FAQCategoryAttributes } from '@/types/faq'
type FormData = z.infer<typeof faqCategorySchema>;

export default function FaqCategoryAddForm() {
    ...
    const onSubmit = async (data: FormData) => {
        try {
            ...
            const response: any = await createFAQCategory(payload);
            if (response?.status === true) { SwalSuccess("FAQ category added successfully."); handleBack(); }
            ...
            <header className="bg-white shadow-sm border-b">
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center h-12">
                        <h1 className="text-xl font-medium text-gray-800 ml-2">Add FAQ Category</h1>
                    </div>
                </div>
            </header>
