      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <img
            ...
            alt="About Us Banner"
            src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/ringCeremonyEventPgBnr.jpg"
          />
      ...
      <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col w-full lg:w-1/2 gap-5">
            ...
            >
             Enhance Your Ring Ceremony Event with Jaipur Food Caterers
            </motion.h2>
            ...
            >
              <p>
               Celebrate the beginning of your beautiful journey with  <span className="font-bold">Jaipur Food Caterers</span>
              ! Our exquisite catering services make your ring ceremony a truly memorable event. With a carefully curated menu, we offer a delightful selection of gourmet dishes, from elegant appetizers to flavorful main courses and decadent desserts. Using only the freshest, high-quality ingredients, our expert chefs create a dining experience that perfectly complements your special occasion.
              </p>
               <p>
              At<span className="font-bold">Jaipur Food Caterers</span>
              , we ensure a seamless and hassle-free catering experience, allowing you to focus on your joyous moments. Whether you prefer a lavish buffet, live food stations, or a sophisticated plated service, we tailor everything to match your event’s theme and style. Let us add taste, elegance, and perfection to your ring ceremony, making it an unforgettable celebration!
              </p>
            </motion.div>
          </div>
        </div>
