...
export default function Anniversary({ project }: { project: any }) {
            ...
            <div className="relative w-full">
                ...
                <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
                    <img
                        ...
                        alt="About Us Banner"
                        src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/weddingAnniverseryEventPgBnr-1.jpg"
                    />
            ...
            <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
                    ...
                    <div className="flex flex-col w-full lg:w-1/2 gap-5">
                        ...
                        >
                            Enhance Your Wedding Anniversary with Jaipur Food Caterers
                        </motion.h2>
                        ...
                        >
                            <p>
                                Celebrate your special milestone with <span className="font-bold">
                                    ! Whether it's your first anniversary or a golden jubilee, we make your celebration unforgettable with exquisite catering. Our expert chefs craft a customized menu filled with delicious dishes made from fresh, high-quality ingredients. From elegant appetizers to gourmet main courses and delightful desserts, we ensure a dining experience that perfectly complements your joyous occasion.
                                </span>
                            </p>
                            <p>
                                At <span className="font-bold">Jaipur Food Caterers</span>
                                , we handle everything from menu planning to seamless service, allowing you to cherish every moment with your loved ones. Whether it’s a cozy dinner or a grand celebration, we provide beautifully presented food and impeccable hospitality. Let us add flavor, elegance, and warmth to your wedding anniversary, making it a truly memorable experience!
                            </p>
                        </motion.div>
                    </div>
                </div>
