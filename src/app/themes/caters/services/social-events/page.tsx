      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <img
            ...
            alt="About Us Banner"
            src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/socialEventPgBnr.jpg"
          />
      ...
      <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col w-full lg:w-1/2 gap-5">
            ...
            >
              Enhance Your Social Event with Jaipur Food Caterers
            </motion.h2>
            ...
            >
              <p>
              Make your social event truly special with  <span className="font-bold">Jaipur Food Caterers</span>
              ! Whether it’s a family gathering, festive celebration, or community event, we bring exceptional flavors and impeccable service to your occasion. Our expert chefs curate customized menus featuring a variety of delicious dishes made with fresh, high-quality ingredients. With beautifully presented food and seamless service, we ensure a delightful dining experience that leaves a lasting impression on your guests.
              </p>
             <p>
               At <span className="font-bold">Jaipur Food Caterers</span>
              , we take care of every detail, from setup to serving, allowing you to enjoy your event stress-free. Whether you need themed food stations, buffet-style service, or a plated dining experience, we tailor everything to match your preferences. Let us bring taste, quality, and elegance to your social gathering, making it a memorable celebration for everyone!
              </p>
            </motion.p>
          </div>
        </div>
