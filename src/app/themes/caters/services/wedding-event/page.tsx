      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <img
            ...
            alt="About Us Banner"
            src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/weddingEventPgBnr.jpg"
          />
      ...
      <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col w-full lg:w-1/2 gap-5">
            ...
            >
              Enhance Your Wedding Event with Jaipur Food Caterers
            </motion.h2>
            ...
            >
              <p>
                Make your wedding celebration unforgettable with our exceptional catering services. From intimate gatherings to grand receptions, we offer a diverse range of mouthwatering dishes, tailored to your tastes and preferences. Our expert chefs craft exquisite menus using fresh, high-quality ingredients, ensuring a delightful culinary experience for you and your guests. With beautifully presented dishes and seamless service, we bring elegance and flavor to your special day.
              </p>
              <p>
                Our professional team takes care of every detail, from menu planning to setup and serving, allowing you to enjoy a stress-free celebration. Whether you desire traditional flavors or a fusion of cuisines, we customize every aspect to match your wedding theme. Let us make your big day extra special with delicious food, impeccable service, and a memorable dining experience!
              </p>
            </motion.p>
          </div>
        </div>
