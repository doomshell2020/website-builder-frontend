...
export default function ThemeParty() {
      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <img
            ...
            alt="About Us Banner"
            src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/themepartyPgBnr.jpg"
          />
      ...
      <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col w-full lg:w-1/2 gap-5">
            ...
            >
              Enhance Your Theme Party with Jaipur Food Caterers
            </motion.h2>
            <motion.div
            ...
            >
              <p>
                Turn your theme party into an unforgettable experience with <span className="font-bold">Jaipur Food Caterers</span>!
                Whether it’s a retro night, Bollywood bash, masquerade gala, or any unique concept, we bring your vision to life with
                customized catering. Our expert chefs curate themed menus with delicious, high-quality dishes that perfectly complement
                your party’s vibe.
              </p>

              <p>
                At <span className="font-bold">Jaipur Food Caterers</span>, we go beyond just food—we create an immersive experience.
                Our team ensures seamless service, beautifully styled food presentations, and live food stations that match your theme.
              </p>
            </motion.div>
