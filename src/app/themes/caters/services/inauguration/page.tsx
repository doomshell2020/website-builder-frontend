...
export const Inauguration = (): JSX.Element => {
      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <img
            ...
            alt="About Us Banner"
            src="https://jaipurfoodcaterers.com/wp-content/uploads/2024/08/inaugurationpgBnr-1.jpg"
          />
      ...
      <div className="flex flex-col items-center justify-center gap-10 px-6 md:px-10 lg:px-20 pt-16 pb-10 w-full bg-white rounded-t-[40px] overflow-hidden">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col w-full lg:w-1/2 gap-5">
            ...
            >
             Enhance Your Inauguration Event with Jaipur Food Caterers
            </motion.h2>
            ...
            >
              <p>
              Make your inauguration event truly special with our premium catering services. We offer a diverse selection of mouthwatering dishes, ensuring a delightful experience for your guests. Whether it's a corporate launch or a grand opening, our expert chefs craft customized menus to suit your theme and preferences. With a strong focus on quality, we use only fresh, high-quality ingredients to create delicious and visually appealing dishes.
              </p>
              <p>
               Our professional team ensures seamless execution, from elegant setups to impeccable service. We handle everything, so you can focus on your event without any worries. From welcome drinks to gourmet meals, our catering elevates your inauguration with a touch of sophistication and excellence. Let us make your special occasion a memorable and hassle-free experience!
              </p>
            </motion.p>
          </div>
        </div>
